...
| 周次 | 课件 | 教学内容 |
| ---- | ---- | ---- |
| 第 2 周 | [导论、ADT 与 OOP](202609_DSA_W02_Intro_ADT_OOP.md) | 导论、ADT 与 OOP、Python 基础回顾 |
| 第 3 周 | [算法分析](202609_DSA_W03_Algorithm_Analysis.md) | 大 O、复杂度级别、Python 内建结构性能 |
| 第 4 周 | [栈](202609_DSA_W04_Stack.md) | ADT、实现、括号匹配、进制转换、调度场算法 |
| 第 5 周 | [队列、双端队列与链表](202609_DSA_W05_Queue_Deque_LinkedList.md) | 队列/双端队列；顺序表与链表对比；无序表与有序表 |
| 第 6 周 | [递归、分治与排序](202610_DSA_W06_Recursion_Divide_Sorting.md) | 递归与分治；冒泡/选择/插入/归并/快排与性能对比 |
| 第 7 周 | [贪心与动态规划](202610_DSA_W07_Greedy_DP.md) | 贪心选择性质、最优子结构、状态转移方程 |
| 第 8 周 | [搜索专题](202610_DSA_W08_Search_DFS_BFS_Backtracking.md) | DFS/BFS、回溯与剪枝 |
| 第 9 周 | [树与二叉树遍历](202610_DSA_W09_Tree_Traversal.md) | 树的概念；前中后序与层序遍历；建树 |
| 第 10 周 | [堆与二叉搜索树](202611_DSA_W10_Heap_BST.md) | 堆、堆排序、优先队列、BST |
| 第 11 周 | [AVL 树与并查集](202611_DSA_W11_AVL_DisjointSet.md) | 平衡因子与四种旋转；路径压缩与按秩合并 |
| 第 12 周 | [图的表示与遍历](202611_DSA_W12_Graph_Representation_Traversal.md) | 邻接矩阵/邻接表；BFS 与 DFS；连通分量 |
| 第 13 周 | [最短路](202611_DSA_W13_ShortestPath.md) | Dijkstra、Bellman-Ford、Floyd-Warshall |
| 第 14 周 | [最小生成树与拓扑排序](202612_DSA_W14_MST_TopoSort.md) | Prim、Kruskal；Kahn 算法；DAG 应用 |
